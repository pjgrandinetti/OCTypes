...
/** @addtogroup OCAutoreleasePool
 *  @{
 */

/**
 * .. _OCAutoreleasePool_h:
 *
 * OCAutoreleasePool.h
 * ====================
 *
 * **Author**: Philip (Original Author)
 * **Documentation Editor**: GitHub Copilot
 * **Date**: May 10, 2025
 *
...
/**
 * :func: OCAutoreleasePoolDrain
 * :brief: Drains an autorelease pool, releasing all objects it contains.
 *
 * This function is used to manually release all objects in the pool without
 * deallocating the pool itself. This can be useful in scenarios where the pool
 * needs to be reused.
 *
 * :param pool: The OCAutoreleasePoolRef to be drained. Must not be NULL.
 */
